...
यदि आपका प्रोजेक्ट [एजेंट स्किल्स](https://agentskills.io) भेजता है — [Blume रिपॉज़िटरी स्वयं ऐसा करती है](/docs/advanced/skills) — तो `ai.skills` को उस डायरेक्टरी की ओर संकेत करें जो उन्हें रखती है, और बिल्ड उन्हें [Agent Skills Discovery RFC](https://github.com/cloudflare/agent-skills-discovery-rfc) के अनुसार डिस्कवरी के लिए प्रकाशित करता है:
