...
इस पेज का एक Markdown जुड़वाँ रूप `/404.md` पर भी है, जिसमें वही रिकवरी लिंक होते हैं ([`deployment.site`](/docs/deployment) सेट होने पर पूर्ण URL के रूप में)। किसी [Vercel सर्वर बिल्ड](/docs/deployment#server-rendering) पर, किसी अनुपस्थित पेज के लिए ऐसा अनुरोध जो [`Accept: text/markdown`](/docs/configuration/ai#content-negotiation) भेजता है, या ऐसे `.md` URL की माँग करता है जिसके पीछे कोई पेज नहीं है, उसे HTML शेल के बजाय `404` स्टेटस के साथ वही Markdown बॉडी मिलती है — ताकि किसी एजेंट को यह जानने के लिए कि आगे कहाँ जाना है, क्रोम से भरा पूरा पेज कभी पार्स न करना पड़े।
