...
:::note
Os recursos de servidor têm sua própria configuração — por exemplo, o Ask AI precisa de uma chave de API de modelo. Consulte o [guia de IA](/docs/configuration/ask-ai) para a configuração.
:::
