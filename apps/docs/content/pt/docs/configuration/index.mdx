...
Imagens Open Graph, feeds RSS e dados estruturados JSON-LD, agrupados em `seo`. Consulte o [guia de SEO](/docs/discoverability) para metadados, substituições no frontmatter e a referência completa.
...
| `ai` | `llms.txt`, Ask AI e o servidor MCP hospedado para agentes de programação | [IA](/docs/discoverability) |
| `analytics` | Vercel, PostHog e scripts personalizados | [Analytics](/docs/configuration/analytics) |
| `seo` | Metadados, imagens OG, feeds, dados estruturados | [SEO](/docs/discoverability) |
