...
- **`subsets`** — os subconjuntos de caracteres a carregar, pelos nomes do provedor (`latin`, `latin-ext`, `vietnamese`, `cyrillic`, `greek`, …). O padrão é `latin` mais o que os idiomas configurados precisarem — veja abaixo.
