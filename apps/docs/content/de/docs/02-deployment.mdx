...
- eine [`sitemap.xml`](/docs/discoverability/sitemap-and-robots#sitemap) und [`robots.txt`](/docs/discoverability/sitemap-and-robots#robots), wenn `deployment.site` gesetzt ist
...
Statische Ausgabe deckt die meisten Dokumentationen ab. Wechsle zur Server-Ausgabe, wenn du Funktionen zur Anfragezeit benötigst — insbesondere den [Ask AI](/docs/configuration/ask-ai)-Endpunkt:
...
:::note
Serverfunktionen haben ihre eigene Konfiguration — Ask AI benötigt beispielsweise einen API-Schlüssel für ein Modell. Zur Einrichtung siehe den [KI-Leitfaden](/docs/configuration/ask-ai).
:::
