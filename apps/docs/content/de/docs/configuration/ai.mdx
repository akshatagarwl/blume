...
Das Manifest listet nur auf, was du aktiviert hast — das Spiegelmuster für [rohes Markdown](#raw-markdown), [`llms.txt`](#llmstxt) und `llms-full.txt`, den [MCP-Server](#mcp-server) und sein Discovery-Dokument, den [Ask AI](#ask-ai)-Endpunkt, die [Sitemap](/docs/configuration/seo#sitemap) und [RSS-Feeds](/docs/configuration/seo#rss-feeds) — neben deinem Website-Namen, der Beschreibung, dem Quell-Repository und der [Content-Signal](/docs/configuration/seo#content-signals)-Nutzungsrichtlinie. URLs sind absolut, wenn [`deployment.site`](/docs/deployment) gesetzt ist, andernfalls stammrelativ:
